...
```
第1天：了解架构全貌
  └─ 📚_分层能力指南.md（本文档）→ 理解五层架构

第2-3天：快速数据探索
  └─ 📗_分析层能力详解.md → Contour 基础分析

第4-5天：简单应用构建
  └─ 📙_应用层能力详解.md → Workshop 基础应用
...
```
第8-10天：数据集成与处理
  ├─ 📘_数据层能力详解.md → Data Connection 深入
  ├─ palantir/03.Data Connection.md → 200+ 连接器详解
  └─ palantir/02.Pipeline Builder.md → ETL 构建

第11-13天：高级分析
  ├─ 📗_分析层能力详解.md → Quiver 时序分析
  ├─ palantir/06.Data Lineage.md → 数据治理
  └─ palantir/56.地理空间分析.md → 地理分析

第14-17天：复杂应用开发
  ├─ 📙_应用层能力详解.md → Workshop 高级特性
  ├─ palantir/08.Notepad.md → 协作报告
  └─ palantir/09.Object Explorer.md → 对象浏览
...
第21-25天：AI 与自动化
  ├─ 📕_AI层能力详解.md → 完整 AI 栈
  ├─ palantir/14-15.RAG 框架 → 智能问答
  ├─ palantir/19.AIP Agents.md → 自主决策
  ├─ palantir/16.MLOps.md → 模型运维
  └─ palantir/17,28.计算机视觉 → CV 能力
...
#### **我想快速分析数据？**
→ 📗_分析层能力详解.md → Contour 基础

#### **我想构建业务应用？**
→ 📙_应用层能力详解.md → Workshop 应用

#### **我想接入企业数据源？**
→ 📘_数据层能力详解.md → Data Connection

#### **我想生成自动化报告？**
→ 📙_应用层能力详解.md → Notepad 协作文档

#### **我想进行 AI 决策？**
→ 📕_AI 层能力详解.md → AIP Agent 与 Logic
